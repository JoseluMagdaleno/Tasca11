...
class Bolita(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Cargar imagen
        self.image = pygame.image.load('/home/cicles/AO/Tasca10/Tasca11/Imatges/bola.png')
...
class Paleta(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('/home/cicles/AO/Tasca10/Tasca11/Imatges/barra.png')
        # Obtener rectangulo de la imagen
        self.rect = self.image.get_rect()
...
class Ladrillo(pygame.sprite.Sprite):
    def __init__(self, posicion):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('/home/cicles/AO/Tasca10/Tasca11/Imatges/ladrillo.png')
        # Obtener rectangulo de la imagen
        self.rect = self.image.get_rect()
